    <aside class="fixed top-0 left-0 z-40 w-64 h-screen border-r border-gray-200 bg-white">
        <div class="h-full px-3 py-4 overflow-y-auto flex flex-col justify-between">
            ...
            <div>
                <div class="flex items-center ps-2.5 mb-10">
                    <a href="<?php echo e(route('dashboard')); ?>">
                        <img src="<?php echo e(asset('img/logo.png')); ?>" class="h-10 w-auto object-contain" alt="Logo" />
                    </a>
                </div>
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="<?php echo e(route('dashboard')); ?>" 
                        class="flex items-center p-2 rounded-lg group <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-50 text-blue-600' : 'text-gray-900 hover:bg-gray-100'); ?>">
                        <i class="fa-solid fa-house"></i>
                            <span class="ms-3">Pagina inicial</span>
                        </a>
                    </li>
                    <?php if(in_array(auth()->user()->role, ['user_controle', 'user_admin'])): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if(in_array(auth()->user()->role, ['user_multas', 'user_admin'])): ?>
                    <li>
            ...
            <div class="border-t pt-4">
                <div class="px-2 mb-2">
                    <p class="text-sm font-bold text-gray-700 truncate"><?php echo e(Auth::user()->name); ?></p>
                    <p class="text-xs text-gray-500 truncate"><?php echo e(Auth::user()->email); ?></p>
                </div>
                
                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
    ...
    </aside><?php /**PATH /home/sidnney/projetos/appFrota/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>